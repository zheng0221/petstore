...
<div id="divmenu">
		<a href="${pageContext.request.contextPath}/showProductByPage?category=dog">活力旺旺</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=cat">优雅喵喵</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=mouse">口袋怪售</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=panda">掌上明珠</a> 
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:right; padding-right:220px">
				Search 
				<input type="text" name="textfield" class="inputtable" id="textfield" value="请输入萌宠名"
